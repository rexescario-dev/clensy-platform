...
| | URL | Notes |
| --- | --- | --- |
| Web console | http://localhost:3001 | Next.js — `/login` (public); `/app/*` shell (protected): `/app`, `/app/admin` (staff/roles, Owner-only), `/app/customers`, `/app/cleaners`, `/app/cleaners/teams`, `/app/catalog`, `/app/catalog/add-ons`, `/app/bookings`, `/app/jobs` |
